...
colnames(rawtraindata[, which(nafreq > 0.6)])
...
#write.csv(train_dataF, file = "/Users/lucyy/Documents/AdvanceDataSci/MidTermProject/DataCleaning_R/preprocessing data.csv")
...
#write.csv(train_dataF, file = "/Users/lucyy/Documents/AdvanceDataSci/MidTermProject/DataCleaning_R/preprocessing data.csv")
selectFeature <- index[index == TRUE]
str(selectFeature)

write.csv(train_dataF, file = "newRawData.csv")
